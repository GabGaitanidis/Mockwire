                ...
                <div className="mb-6 p-4 bg-purple-50 border border-purple-200 rounded-lg">
                  <div className="flex items-start gap-2">
                    ...
                    <div className="text-sm text-purple-800">
                      <p className="font-semibold mb-1">How to Test Your API</p>
                      <p>
                        1. Select a rule from the dropdown. 2. Generate a unique
                        URL. 3. Test the URL to see mock data with latency and
                        error simulation.
                      </p>
                    </div>
                  </div>
                ...
                {generatedUrl && (
                  <div className="space-y-4">
                    <div className="p-4 bg-gray-100 rounded-lg border border-gray-300">
                      ...
                      <code className="text-sm break-all font-mono text-gray-800 block overflow-auto">
                        {generatedUrl}
                      </code>
                    </div>
